...
class StoreSolicitudServidorRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'medio_pago' => ['required', Rule::in(['transferencia_bancaria', 'tarjeta_credito', 'paypal'])],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'medio_pago.in' => 'El medio de pago debe ser transferencia bancaria, tarjeta de credito o PayPal.',
        ];
    }
}
